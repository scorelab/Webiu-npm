    ...
    <div className="gitter-rooms-list-component">
      <Container>
        <Row>
          ...
          {loading || rooms===null ? <Col md={12}><p>Loading...</p></Col> : renderRoomList()}
        </Row>
        <Row>
        <Col className="view-all-btn-container">
          {loading || !rooms ? null : 
                      <a href={`https://gitter.im/${gitterOrganizationName}`} className="gitter-anchor" target="_blank" rel="noreferrer">
