...
export const ContactComponent = ({contactMessage, subscribeMessage, contactTitle, subscribeTitle, handleContactSubmit = () => {}, handleSubscribeSubmit = () => {}}) => {
  ...
  return (
    <div className="contact-component" style={{ backgroundImage: dots }}>
      <Container>
        <Row>
          <Col md={6}>
          ...
          <Col md={6}>
            ...
            <img className="subscribe-image" alt="subscribe" src={emailIcon} />
