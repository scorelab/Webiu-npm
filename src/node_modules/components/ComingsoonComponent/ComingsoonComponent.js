...
export const ComingsoonComponent = ({ countdownText, header, buttonText, buttonLink, deployDate, image, message }) => {
                    ...
                    <div className="countdown-content-section">
                        ...
                        {buttonText ? 
                          <div className="button-div">
                            <a href={buttonLink} className="countdown-button">{buttonText}</a> 
                          </div>
                        : null}
                    </div>
                    </Col>
